...
int main( int argc, char *argv[] )
{
	...
	*************************************************************************/
	char *op_loadi 	= "00000000";//loadi
	char *op_mov 	= "00000001";//mov
	char *op_add 	= "00000010";//add
	char *op_sub 	= "00000011";//sub
	char *op_and 	= "00000100";//and
	char *op_or 	= "00000101";//or
	char *op_j	= "00000110";//j
	char *op_beq	= "00000111";//beq
	char *op_lwd 	= "00001101";//lwd
	char *op_lwi 	= "00001110";//lwi
	char *op_swd 	= "00001111";//swd
	char *op_swi 	= "00010000";//swi
	/************************************************************************/
